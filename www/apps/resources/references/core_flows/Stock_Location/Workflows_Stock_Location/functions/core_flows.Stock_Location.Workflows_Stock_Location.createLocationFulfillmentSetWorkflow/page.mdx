...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/876a14eb98aed54360312b9b215599aa46faccd8/packages/core/core-flows/src/stock-location/workflows/create-location-fulfillment-set.ts#L35" />
